...
public class TransitDetails {
    ...
    public TransitDetails(final GoogleStop arrival_stop, final GoogleTime arrival_time, final GoogleStop departure_stop, final GoogleTime departure_time, final String headsign, final Line line, final int num_stops)
    {
